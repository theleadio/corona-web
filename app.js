...
const v4AnalyticsRouter = require('./routes/v4/analytics');
const v5AnalyticsRouter = require('./routes/v5/analytics');
...
app.use(cors({ origin: ["https://coronatracker.com", /\.coronatracker\.com$/] }));
...
app.use('/v4/analytics', v4AnalyticsRouter);
app.use('/v5/analytics', v5AnalyticsRouter);
